...
echo -e "\n\n${brk}\nAlgod Monitor - View Logs - Report Viewer\n${brk}\n";
echo -e "Display 'Algod Monitor' reports and file information on screen.\n\nPlease specify a component when running the 'View Logs' command.\n";
